...
\par La comprensión lectora es una habilidad fundamental para el acceso a la información, a la educación y para la participación social. 
A pesar de esto, hay un gran número de personas que encuentran problemas a la hora de entender textos escritos, ya sea por razones cognitivas, educativas o sociales.
Entre estas personas se incluyen aquellas con discapacidad intelectual, con dificultades de aprendizaje, personas mayores, personas inmigrantes con poco dominio del idioma 
y otros colectivos que se pueden ver afectados de forma similar.
\\
\par Para solucionar esto surge la iniciativa de la Lectura Fácil, un método que promueve la creación de documentos accesibles mediante un 
conjunto de pautas concretas de redacción, maquetación, diseño y validación. Estas pautas las podemos encontrar redactadas en normativas reconocidas 
a nivel europeo como las promovidas por Inclusion Europe y la Asociación Española de Lectura Fácil (ALF).
En este contexto las tecnologías innovadoras de Inteligencia Artificial (IA), como los modelos generativos de lenguaje, pueden ser de gran ayuda para
mejorar la accesibilidad de los textos de forma automatizada. Estos modelos entrenados con grandes cantidades de datos lingüísticos son capaces de generar texto coherente 
y relevante a partir de un texto de entrada, lo que puede facilitar la creación de resúmenes y explicaciones adaptadas a las necesidades de los usuarios siguiendo las pautas de Lectura Fácil.
\\
\par En este trabajo se propone diseñar y evaluar un sistema de IA generativa orientado a la producción de textos en lectura facilitada, siguiendo solamente las pautas de Lectura Fácil 
correspondientes a la redacción de los textos. Esto con el objetivo de investigar la eficacia de los modelos extensos de lenguaje (LLM) en la generación de textos accesibles, y para ello 
se utilizarán diferentes técnicas de procesamiento del lenguaje natural (NLP) y aprendizaje automático (ML), además de explorar distintas estrategias como el Prompt Engineering y la evaluación automática y manual de resultados.
\\
