...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Título y subtítulo
\newcommand{\titulo}{Sistema de IA generativa para lectura facilitada}
\newcommand{\subtitulo}{Sistema}
% Datos del autor
\newcommand{\miNombre}{Nizar Nortes Pastor}
% Determinar género para etiquetas Autore/Autora/Autor (nb o en blanco,f,m)
\newcommand{\miGenero}{m}
\newcommand{\miEmail}{nnpn1@alu.ua.es}
% Datos del tutor/es
% Si no hay tutorB, comentar tutorB y dptoB para que la etiqueta sea Tutor:
\newcommand{\miTutor}{José Ignacio Abreu Salas}
\newcommand{\miTutorB}{Rafael Muñoz Guillena}
\newcommand{\departamentoTutor}{Lenguajes y sistemas informáticos}
\newcommand{\departamentoTutorB}{Lenguajes y sistemas informáticos}
